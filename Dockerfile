...
ADD https://github.com/kkharji/sqlite.lua.git ${ppath}/sqlite.lua/start/sqlite.lua
ADD https://github.com/ecthelionvi/NeoComposer.nvim.git ${ppath}/NeoComposer.nvim/start/NeoComposer.nvim
ADD https://github.com/NeogitOrg/neogit.git ${ppath}/neogit/start/neogit
ADD https://github.com/lewis6991/gitsigns.nvim.git ${ppath}/gitsigns.nvim/start/gitsigns.nvim
ADD https://github.com/ThePrimeagen/git-worktree.nvim.git ${ppath}/git-worktree.nvim/start/git-worktree.nvim
ADD https://github.com/nvim-treesitter/nvim-treesitter.git ${ppath}/nvim-treesitter/start/nvim-treesitter
